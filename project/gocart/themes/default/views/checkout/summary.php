	...
	<div class="panel panel-default font">
		...
		<div class="panel-body">
			<table class="table table-striped">
				<thead>
					<tr>
						<th style="width:10%; font-weight:400"><?php echo lang('sku');?></th>
						<th style="width:20%; font-weight:400">PRODUCTO</th>
						<th style="width:10%; font-weight:400">PRECIO</th>
						<th style="font-weight:400">DESCRIPCIÓN</th>
						<th style="width:10%; font-weight:400">CANTIDAD</th>
						<th style="width:8%; font-weight:400">TOTALES</th>
					</tr>
				</thead>
										...
										<div class="control-group">
											<div class="controls">
												<div class="input-append">
													...
													<button class="btn btn-danger" type="button" onclick="if(confirm('<?php echo lang('remove_item');?>')){window.location='<?php echo site_url('cart/remove_item/'.$cartkey);?>';}"><i class="fa fa-times"></i></button>
												</div>
											</div>
										</div>
									<?php else:?>
