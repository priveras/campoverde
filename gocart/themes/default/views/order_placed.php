...
<div class="row font">
	...
	<div class="col-lg-3">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<p><?php echo (!empty($customer['company']))?$customer['company'].'<br/>':'';?></p>
				<p>
	...
	<div class="col-lg-3">
		<div class="panel panel-default">
			<div class="panel-heading">Información para Envío</div>
			<div class="panel-body">
				<p><?php echo (!empty($customer['']))?$customer[''].'<br/>':'';?></p>
				<p>
...
<div class="row">
	<div class="col-lg-12 text-center">
		<a href="<?php echo base_url()?>"><div class="btn btn-success" style="width:300px;">Finalizar</div></a>
	</div>
</div>