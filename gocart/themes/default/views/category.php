...
<div class="text-center category-header">
  <h2>Carne de <?php echo $category->name; ?></h2>
</div>
<br>
<hr>
<br>
...
<div class="row text-center">
    ...
    <div class="col-lg-8 text-justify category-description">
        ...
        <?php elseif(count($products) > 0):?>
            ...
            <div class="row" style="margin-top:20px; margin-bottom:15px">
                ...
                <div class="col-lg-3 pull-right ">
                    <select class="col-lg-12 form-control" id="sort_products" onchange="window.location='<?php echo site_url(uri_string());?>/'+$(this).val();">
